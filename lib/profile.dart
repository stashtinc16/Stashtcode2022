                ...
                children: [
                  Stack(
                    ...
                    children: [
                      ...
                      const Padding(padding:EdgeInsets.only(top: 30) ,child:
                      ...
                      children: [
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            ...
                            const Text("Change",style: TextStyle(color: Color.fromRGBO(108, 96, 255, 1),
                              fontSize: 16,
                              fontWeight: FontWeight.w400,),
                            ),
                          ],
                        ...
                        const Text("Connected Accounts",textAlign: TextAlign.start ,style:  TextStyle(color: Colors.grey,
                          fontSize: 15,
                          fontWeight: FontWeight.w400,),),
                        const SizedBox(height: 15,),
                        Row(
                          children: [
                            ...
                            FlutterSwitch(
                              ...
                              activeColor: const Color.fromRGBO(108, 96, 255, 1),
                              value: status1,
                              onToggle: (val) {
                                setState(() {
                                  status1 = val;
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 15,),
                            const Text("Photos",textAlign: TextAlign.start ,style:  TextStyle(color: Colors.black,
                              fontSize: 14,),),
                        ...
                        Row(
                          children: [
                            ...
                            const Text("Dropbox",textAlign: TextAlign.start ,style:  TextStyle(color: Colors.black,
                              fontSize: 14,),),
