...
class _Memories_Empty extends State<Memories_Empty> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: commonAppbar(context,isMemory?"Memories":isPhotos?"All Photos":isNotification?"Notifications":"Settings", pageSelected: (bool isMemory, bool isPhotos, bool isNotification, bool isSettings) {
        setState(() {
      ...
      body: isMemory?SingleChildScrollView(child: Padding(
        padding: const EdgeInsets.all(20),
        child: Center(
          child: Column(
            children: [
              Image.asset("assets/images/memoryempty.png",height: 230,),
              const SizedBox(
                height: 10,
              ),
              const Text(
      ...
      ):isPhotos?const All_Photos():isNotification?Notifications():Profile(),
      floatingActionButton:isMemory? SizedBox(
          height: 79,
          width: 79,
          child: FittedBox(
