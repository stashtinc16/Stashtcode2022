                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: controller
                                                              ...
                                                              : Text(
                                                                  controller.detailMemoryModel!.imagesCaption![index].userModel !=
                                                                          null
                                                                      ? controller
                                                                          .detailMemoryModel!
                                                                          .imagesCaption![
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    ...
                                                                    const SizedBox(
                                                                        width:
                                                                            10),
                                                                    if (controller.detailMemoryModel!.imagesCaption![index].userId ==
                                                                            userId ||
                                                                        controller.detailMemoryModel!.createdBy ==
                                                                            userId)
                                                                      Container(
                                                                        width:
                                                                            30,
