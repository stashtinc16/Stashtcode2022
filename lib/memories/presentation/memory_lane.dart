              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: NetworkImage(
                            controller.memoriesList[mainIndex!].imagesCaption[0].image),
                        fit: BoxFit.cover),
                  ),
                  child: Padding(
                        ...
                        Center(
                          ...
                          children: [
                            ...
                            Padding(
                                ...
                                child: Text(
                                  controller.memoriesList[mainIndex!].title!,
              ...
              Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ListView.builder(
                      itemCount:
                          controller.memoriesList[mainIndex!].imagesCaption.length,
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                    controller.memoriesList[mainIndex!].imagesCaption[index].caption
                                            .isEmpty
                                        ? 'Add caption to this Post...'
                                        : controller
                                            .memoriesList[mainIndex!].imagesCaption[index].caption,
                                    textAlign: TextAlign.start,
                                    style:  TextStyle(
                                        color: controller.memoriesList[mainIndex!].imagesCaption[index].caption.isEmpty
                                        ? AppColors.textColor : AppColors.darkColor,
                                        fontSize: controller.memoriesList[mainIndex!].imagesCaption[index].caption.isEmpty
                                        ? 12 : 14,
